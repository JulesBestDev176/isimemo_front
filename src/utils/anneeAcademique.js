 ...
 */
export const getAnneeAcademiqueCourante = () => {
 ...
 */
export const isAnneeAcademiqueTerminee = (anneeAcademique) => {
 ...
 */
export const getAnneeAcademiqueFromDate = (date) => {
 ...
 */
export const hasRoleActifPourAnneeCourante = (user, anneeAcademique) => {
    if (!user)
        return false;
    ...
    return ((user.estEncadrant || user.estJurie || user.estCommission) &&
