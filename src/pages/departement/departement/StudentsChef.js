...
import { Search, User, GraduationCap, Download, Upload, Filter, Edit, Check, X, Eye, BarChart3, FileText, School, Mail, Phone, MapPin, BookOpen, Award, CheckCircle, History, Clock } from 'lucide-react';
import { useAuth } from '../../../contexts/AuthContext';
import { getDossierEnCoursByCandidat, getDossiersTerminesByCandidat, StatutDossierMemoire, mockDossiers } from '../../../models/dossier/DossierMemoire';
import { getDocumentsByDossier, getDocumentsAdministratifs, getDocumentsDeposesByDossier, TypeDocument, StatutDocument } from '../../../models/dossier/Document';
...
const StudentDetailsModal = ({ studentItem, isOpen, onClose }) => {
    ...
    const dossierActif = useMemo(() => {
        if (!(studentItem === null || studentItem === void 0 ? void 0 : studentItem.idCandidat))
            return undefined;
        return getDossierEnCoursByCandidat(studentItem.idCandidat);
    }, [studentItem === null || studentItem === void 0 ? void 0 : studentItem.idCandidat]);
    ...
    const documentMemoire = documentsDossierActif.find(d => d.typeDocument === TypeDocument.CHAPITRE ||
    ...
    const documentsDeposes = dossierActif
        ? getDocumentsDeposesByDossier(dossierActif.idDossierMemoire).filter(d => d.typeDocument !== TypeDocument.CHAPITRE &&
            d.typeDocument !== TypeDocument.PRESENTATION)
        : [];
    ...
    const [documentAConsulter, setDocumentAConsulter] = useState(null);
    ...
    return (_jsxs("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: [_jsxs(motion.div, { initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.95 }, className: "bg-white border border-gray-200 p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto", children: [_jsxs("div", { className: "flex justify-between items-start mb-6", children: [_jsxs("div", { children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 mb-2", children: [studentItem.firstName, " ", studentItem.lastName] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: studentItem.active ? 'active' : 'inactive', children: studentItem.active ? 'Actif' : 'Inactif' }), _jsx(Badge, { variant: "primary", children: studentItem.level })] })] }), _jsx("button", { onClick: onClose, className: "p-2 text-gray-400 hover:text-gray-600 transition-colors", children: _jsx(X, { className: "h-6 w-6" }) })] }), dossierActif ? (_jsxs("div", { className: "mb-6 pb-6 border-b border-gray-200", children: [_jsxs("h3", { className: "text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2", children: [_jsx(FileText, { className: "h-5 w-5 text-primary" }), "Dossier M\u00E9moire Actif"] }), _jsx("div", { className: "bg-primary-50 border-2 border-primary-200 rounded-lg p-5", children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-bold text-lg text-gray-900 mb-2", children: dossierActif.titre }), _jsx("p", { className: "text-sm text-gray-700 mb-3", children: dossierActif.description })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Statut" }), _jsx("span", { className: `inline-block px-3 py-1 text-xs font-medium rounded border ${getStatutBadgeColor(dossierActif.statut)}`, children: dossierActif.statut })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "\u00C9tape" }), _jsx("span", { className: "text-sm text-gray-900", children: dossierActif.etape })] }), dossierActif.anneeAcademique && (_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Ann\u00E9e acad\u00E9mique" }), _jsx("span", { className: "text-sm text-gray-900", children: dossierActif.anneeAcademique })] })), dossierActif.encadrant && (_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Encadrant" }), _jsxs("span", { className: "text-sm text-gray-900", children: [dossierActif.encadrant.prenom, " ", dossierActif.encadrant.nom] })] })), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Date de cr\u00E9ation" }), _jsxs("span", { className: "text-sm text-gray-900 flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), format(dossierActif.dateCreation, 'dd/MM/yyyy', { locale: fr })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Derni\u00E8re modification" }), _jsxs("span", { className: "text-sm text-gray-900 flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), format(dossierActif.dateModification, 'dd/MM/yyyy', { locale: fr })] })] })] }), dossierActif.binome && (_jsxs("div", { className: "pt-3 border-t border-primary-200", children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Bin\u00F4me" }), _jsxs("span", { className: "text-sm text-gray-900", children: [dossierActif.binome.candidat1.prenom, " ", dossierActif.binome.candidat1.nom, " & ", dossierActif.binome.candidat2.prenom, " ", dossierActif.binome.candidat2.nom] })] })), documentMemoire && (_jsxs("div", { className: "pt-3 border-t border-primary-200", children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-2", children: "Document du m\u00E9moire" }), _jsxs("div", { className: "bg-white border border-primary-200 rounded-lg p-3 flex items-center justify-between hover:bg-primary-50 transition-colors", children: [_jsxs("div", { className: "flex items-center gap-3 flex-1", children: [_jsx(FileText, { className: "h-5 w-5 text-primary" }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-sm font-medium text-gray-900", children: documentMemoire.titre }), _jsxs("div", { className: "flex items-center gap-2 mt-1", children: [_jsx("span", { className: `text-xs px-2 py-0.5 rounded ${documentMemoire.statut === StatutDocument.VALIDE ? 'bg-green-100 text-green-700' :
                                                                                        documentMemoire.statut === StatutDocument.DEPOSE ? 'bg-blue-100 text-blue-700' :
                                                                                            documentMemoire.statut === StatutDocument.EN_ATTENTE_VALIDATION ? 'bg-yellow-100 text-yellow-700' :
                                                                                                'bg-gray-100 text-gray-700'}`, children: documentMemoire.statut }), _jsx("span", { className: "text-xs text-gray-500", children: format(documentMemoire.dateModification || documentMemoire.dateCreation, 'dd/MM/yyyy', { locale: fr }) })] })] })] }), _jsxs("button", { onClick: () => setDocumentAConsulter(documentMemoire), className: "ml-4 px-3 py-1.5 text-sm text-primary border border-primary rounded hover:bg-primary hover:text-white transition-colors flex items-center gap-2", children: [_jsx(Eye, { className: "h-4 w-4" }), "Consulter"] })] })] })), documentsDeposes.length > 0 && (_jsxs("div", { className: "pt-3 border-t border-primary-200", children: [_jsxs("label", { className: "block text-xs font-medium text-gray-500 mb-2", children: ["Documents d\u00E9pos\u00E9s (", documentsDeposes.length, ")"] }), _jsx("div", { className: "space-y-2", children: documentsDeposes.map((doc) => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-2 flex items-center justify-between hover:bg-gray-50 transition-colors", children: [_jsxs("div", { className: "flex items-center gap-2 flex-1", children: [_jsx(Download, { className: "h-4 w-4 text-gray-400" }), _jsx("span", { className: "text-sm text-gray-700", children: doc.titre }), _jsxs("span", { className: "text-xs text-gray-500", children: ["(", doc.typeDocument, ")"] })] }), _jsxs("button", { onClick: () => setDocumentAConsulter(doc), className: "ml-2 px-2 py-1 text-xs text-primary border border-primary rounded hover:bg-primary hover:text-white transition-colors flex items-center gap-1", children: [_jsx(Eye, { className: "h-3 w-3" }), "Voir"] })] }, doc.idDocument))) })] })), documentsAdministratifs.length > 0 && (_jsxs("div", { className: "pt-3 border-t border-primary-200", children: [_jsxs("label", { className: "block text-xs font-medium text-gray-500 mb-2", children: ["Dossiers administratifs (", documentsAdministratifs.length, ")"] }), _jsx("div", { className: "space-y-2", children: documentsAdministratifs.map((doc) => (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg p-2 flex items-center justify-between hover:bg-gray-50 transition-colors", children: [_jsxs("div", { className: "flex items-center gap-2 flex-1", children: [_jsx(FileText, { className: "h-4 w-4 text-gray-400" }), _jsx("span", { className: "text-sm text-gray-700", children: doc.titre }), _jsx("span", { className: `text-xs px-2 py-0.5 rounded ${doc.statut === StatutDocument.VALIDE ? 'bg-green-100 text-green-700' :
                                                                            'bg-gray-100 text-gray-700'}`, children: doc.statut })] }), _jsxs("button", { onClick: () => setDocumentAConsulter(doc), className: "ml-2 px-2 py-1 text-xs text-primary border border-primary rounded hover:bg-primary hover:text-white transition-colors flex items-center gap-1", children: [_jsx(Eye, { className: "h-3 w-3" }), "Voir"] })] }, doc.idDocument))) })] })), _jsxs("div", { className: "flex items-center gap-4 pt-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [dossierActif.estComplet ? (_jsx(CheckCircle, { className: "h-4 w-4 text-green-600" })) : (_jsx(X, { className: "h-4 w-4 text-red-500" })), _jsx("span", { className: "text-xs text-gray-600", children: dossierActif.estComplet ? 'Dossier complet' : 'Dossier incomplet' })] }), dossierActif.autoriseSoutenance && (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(CheckCircle, { className: "h-4 w-4 text-green-600" }), _jsx("span", { className: "text-xs text-gray-600", children: "Soutenance autoris\u00E9e" })] }))] })] }) })] })) : (_jsx("div", { className: "mb-6 pb-6 border-b border-gray-200", children: _jsxs("div", { className: "bg-gray-50 border border-gray-200 rounded-lg p-4 text-center", children: [_jsx(FileText, { className: "h-8 w-8 text-gray-400 mx-auto mb-2" }), _jsx("p", { className: "text-sm text-gray-600", children: "Aucun dossier m\u00E9moire actif" })] }) })), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-6", children: [_jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Informations g\u00E9n\u00E9rales" }), _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500", children: "Email" }), _jsxs("p", { className: "text-gray-900 flex items-center", children: [_jsx(Mail, { className: "h-4 w-4 text-gray-400 mr-2" }), studentItem.email] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500", children: "Classe" }), _jsxs("p", { className: "text-gray-900 flex items-center", children: [_jsx(School, { className: "h-4 w-4 text-gray-400 mr-2" }), studentItem.class] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500", children: "Derni\u00E8re mise \u00E0 jour" }), _jsx("p", { className: "text-gray-900", children: studentItem.lastUpdated })] })] })] }), _jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Informations personnelles" }), _jsxs("div", { className: "space-y-3", children: [studentItem.phoneNumber && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500", children: "T\u00E9l\u00E9phone" }), _jsxs("p", { className: "text-gray-900 flex items-center", children: [_jsx(Phone, { className: "h-4 w-4 text-gray-400 mr-2" }), studentItem.phoneNumber] })] })), studentItem.address && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500", children: "Adresse" }), _jsxs("p", { className: "text-gray-900 flex items-center", children: [_jsx(MapPin, { className: "h-4 w-4 text-gray-400 mr-2" }), studentItem.address] })] }))] })] })] }), dossiersHistorique.length > 0 && (_jsxs("div", { className: "mb-6 pt-6 border-t border-gray-200", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("h3", { className: "text-lg font-semibold text-gray-900 flex items-center gap-2", children: [_jsx(History, { className: "h-5 w-5 text-primary" }), "Historique des Dossiers (", dossiersHistorique.length, ")"] }), _jsxs("button", { onClick: () => setShowHistory(!showHistory), className: "text-sm text-primary hover:underline flex items-center gap-1", children: [showHistory ? 'Masquer' : 'Afficher', " l'historique"] })] }), showHistory && (_jsx("div", { className: "space-y-3", children: dossiersHistorique.map((dossier) => (_jsx("div", { className: "bg-gray-50 border border-gray-200 rounded-lg p-4 hover:bg-gray-100 transition-colors", children: _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-semibold text-gray-900 mb-1", children: dossier.titre }), _jsx("p", { className: "text-sm text-gray-600 mb-2", children: dossier.description })] }), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Statut" }), _jsx("span", { className: `inline-block px-2 py-1 text-xs font-medium rounded border ${getStatutBadgeColor(dossier.statut)}`, children: dossier.statut })] }), dossier.anneeAcademique && (_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Ann\u00E9e" }), _jsx("span", { className: "text-xs text-gray-900", children: dossier.anneeAcademique })] })), dossier.encadrant && (_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "Encadrant" }), _jsxs("span", { className: "text-xs text-gray-900", children: [dossier.encadrant.prenom, " ", dossier.encadrant.nom] })] })), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: "\u00C9tape" }), _jsx("span", { className: "text-xs text-gray-900", children: dossier.etape })] })] }), _jsxs("div", { className: "text-xs text-gray-500 flex items-center gap-4 pt-2 border-t border-gray-200", children: [_jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), "Cr\u00E9\u00E9: ", format(dossier.dateCreation, 'dd/MM/yyyy', { locale: fr })] }), _jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), "Modifi\u00E9: ", format(dossier.dateModification, 'dd/MM/yyyy', { locale: fr })] })] }), documentsParDossier[dossier.idDossierMemoire] && documentsParDossier[dossier.idDossierMemoire].length > 0 && (_jsxs("div", { className: "pt-2 border-t border-gray-200", children: [_jsxs("label", { className: "block text-xs font-medium text-gray-500 mb-1", children: ["Documents (", documentsParDossier[dossier.idDossierMemoire].length, ")"] }), _jsxs("div", { className: "space-y-1", children: [documentsParDossier[dossier.idDossierMemoire].slice(0, 3).map((doc) => (_jsxs("div", { className: "text-xs text-gray-600 flex items-center justify-between bg-gray-50 rounded p-1.5", children: [_jsxs("div", { className: "flex items-center gap-1 flex-1", children: [_jsx(BookOpen, { className: "h-3 w-3 text-gray-400" }), _jsx("span", { className: "truncate", children: doc.titre })] }), _jsx("button", { onClick: () => setDocumentAConsulter(doc), className: "ml-2 px-1.5 py-0.5 text-xs text-primary border border-primary rounded hover:bg-primary hover:text-white transition-colors flex items-center gap-1", children: _jsx(Eye, { className: "h-3 w-3" }) })] }, doc.idDocument))), documentsParDossier[dossier.idDossierMemoire].length > 3 && (_jsxs("span", { className: "text-xs text-gray-500", children: ["+ ", documentsParDossier[dossier.idDossierMemoire].length - 3, " autre(s)"] }))] })] }))] }) }, dossier.idDossierMemoire))) }))] })), _jsx("div", { className: "flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200", children: _jsx(SimpleButton, { variant: "secondary", onClick: onClose, children: "Fermer" }) })] }), documentAConsulter && (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]", children: _jsxs(motion.div, { initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.95 }, className: "bg-white border border-gray-200 p-6 max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto", children: [_jsxs("div", { className: "flex justify-between items-start mb-4", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-xl font-bold text-gray-900 mb-2", children: documentAConsulter.titre }), _jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [_jsx("span", { className: `text-xs px-2 py-1 rounded ${documentAConsulter.statut === StatutDocument.VALIDE ? 'bg-green-100 text-green-700' :
                                                        documentAConsulter.statut === StatutDocument.DEPOSE ? 'bg-blue-100 text-blue-700' :
                                                            documentAConsulter.statut === StatutDocument.EN_ATTENTE_VALIDATION ? 'bg-yellow-100 text-yellow-700' :
                                                                'bg-gray-100 text-gray-700'}`, children: documentAConsulter.statut }), _jsx("span", { className: "text-xs text-gray-500 px-2 py-1 bg-gray-100 rounded", children: documentAConsulter.typeDocument })] })] }), _jsx("button", { onClick: () => setDocumentAConsulter(null), className: "p-2 text-gray-400 hover:text-gray-600 transition-colors", children: _jsx(X, { className: "h-6 w-6" }) })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500 mb-1", children: "Date de cr\u00E9ation" }), _jsxs("p", { className: "text-sm text-gray-900 flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), format(documentAConsulter.dateCreation, 'dd/MM/yyyy à HH:mm', { locale: fr })] })] }), documentAConsulter.dateModification && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500 mb-1", children: "Derni\u00E8re modification" }), _jsxs("p", { className: "text-sm text-gray-900 flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), format(documentAConsulter.dateModification, 'dd/MM/yyyy à HH:mm', { locale: fr })] })] }))] }), documentAConsulter.commentaire && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500 mb-1", children: "Commentaire" }), _jsx("p", { className: "text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded p-3", children: documentAConsulter.commentaire })] })), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-500 mb-1", children: "Fichier" }), _jsxs("div", { className: "bg-primary-50 border-2 border-primary-200 rounded-lg p-4 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(FileText, { className: "h-8 w-8 text-primary" }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-900", children: documentAConsulter.cheminFichier.split('/').pop() }), _jsx("p", { className: "text-xs text-gray-500", children: documentAConsulter.cheminFichier })] })] }), _jsxs("button", { onClick: () => {
                                                        // Simuler l'ouverture du document
                                                        window.open(documentAConsulter.cheminFichier, '_blank');
                                                    }, className: "px-4 py-2 bg-primary text-white rounded hover:bg-primary-700 transition-colors flex items-center gap-2", children: [_jsx(Eye, { className: "h-4 w-4" }), "Ouvrir"] })] })] })] }), _jsx("div", { className: "flex justify-end space-x-4 mt-6 pt-4 border-t border-gray-200", children: _jsx(SimpleButton, { variant: "secondary", onClick: () => setDocumentAConsulter(null), children: "Fermer" }) })] }) }))] }));
};
// Onglet Liste des étudiants
const StudentListTab = ({ students, onToggleActive, onViewDetails }) => {
    const [searchQuery, setSearchQuery] = useState('');
    const [activeFilter, setActiveFilter] = useState('all');
    const [levelFilter, setLevelFilter] = useState('Licence 3'); // Par défaut, afficher seulement Licence 3
