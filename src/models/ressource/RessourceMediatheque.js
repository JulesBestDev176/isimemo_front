...
// ============================================================================
export const mockRessourcesMediatheque = [
...
export const getRessourcesParCategorie = (categorie) => {
    return mockRessourcesMediatheque.filter(r => r.categorie === categorie && r.estActif !== false);
};
export const getRessourcesImportantes = () => {
 ...
 */
export const activerRessource = (idRessource) => {
 ...
 */
export const getRessourcesInactives = () => {
    return mockRessourcesMediatheque.filter(r => r.estActif === false);
};
/**
 * Ajoute un document à la bibliothèque numérique
 */
export const ajouterRessourceMediatheque = (document, dossier, candidat, estActif = false) => {
    ...
    const nouvelleRessource = {
        ...
        commentaires: 0,
        vues: 0,
        niveau: (candidat === null || candidat === void 0 ? void 0 : candidat.niveau) === 'Licence 3' ? 'licence' : 'master',
        estActif: estActif
    };
