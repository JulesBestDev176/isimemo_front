...
export const mockRessourcesPersonnelles = [
...
// HELPER FUNCTIONS
// ============================================================================
export const getRessourcePersonnelleById = (id) => {
...
export const getRessourcesPersonnellesProfesseur = (idProfesseur) => {
    ...
    return mockRessourcesPersonnelles.filter(r => r.cheminFichier.includes(`/professeurs/${idProfesseur}/`));
};
