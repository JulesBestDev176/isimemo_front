 ...
 */
const isProfesseurEncadrantDuDossier = (idProfesseur, dossierMemoire) => {
    ...
    const encadrementsActifs = encadrements.filter(e => {
        var _a;
        return e.statut === StatutEncadrement.ACTIF &&
            ((_a = e.professeur) === null || _a === void 0 ? void 0 : _a.idProfesseur) === idProfesseur;
    } // Vérifier que l'encadrement appartient bien à ce professeur
    );
    // Vérifier si l'un des encadrements actifs contient un des candidats du dossier
    return encadrementsActifs.some(encadrement => {
        var _a;
        if (!((_a = encadrement.dossierMemoire) === null || _a === void 0 ? void 0 : _a.candidats))
            return false;
        ...
        return dossierMemoire.candidats.some(candidatDossier => {
            var _a, _b;
            return (_b = (_a = encadrement.dossierMemoire) === null || _a === void 0 ? void 0 : _a.candidats) === null || _b === void 0 ? void 0 : _b.some(candidatEncadrement => candidatEncadrement.idCandidat === candidatDossier.idCandidat);
        });
    });
};
/**
 ...
 */
export const getSoutenancesByProfesseur = (idProfesseur) => {
    ...
    const result = mockSoutenances.filter(soutenance => {
        ...
        const estMembreJury = (_a = soutenance.jury) === null || _a === void 0 ? void 0 : _a.some(membre => { var _a; return ((_a = membre.professeur) === null || _a === void 0 ? void 0 : _a.idProfesseur) === idProfesseur; });
        if (idProfesseur === 9) {
 ...
 */
export const getRoleJuryByProfesseur = (soutenance, idProfesseur) => {
    var _a;
    const membre = (_a = soutenance.jury) === null || _a === void 0 ? void 0 : _a.find(m => { var _a; return ((_a = m.professeur) === null || _a === void 0 ? void 0 : _a.idProfesseur) === idProfesseur; });
    return membre === null || membre === void 0 ? void 0 : membre.roleJury;
};
/**
 ...
 */
export const hasSoutenancesAssignees = (idProfesseur) => {
