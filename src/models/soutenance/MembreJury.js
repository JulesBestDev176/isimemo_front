...
// HELPER FUNCTIONS
// ============================================================================
export const getMembreJuryById = (id) => {
    return mockMembresJury.find(m => m.idMembre === id);
};
export const getMembresBySoutenance = (soutenanceId) => {
    ...
    if (soutenanceId === 1)
        return mockMembresJury.slice(0, 4);
    if (soutenanceId === 2)
        return mockMembresJury.slice(4, 8);
    if (soutenanceId === 3)
        return mockMembresJury.slice(8, 11);
    if (soutenanceId === 4)
        return mockMembresJury.slice(11, 14);
    return [];
};
/**
 * Récupère les membres du jury pour un professeur donné
 */
export const getMembresJuryByProfesseur = (idProfesseur) => {
    return mockMembresJury.filter(m => { var _a; return ((_a = m.professeur) === null || _a === void 0 ? void 0 : _a.idProfesseur) === idProfesseur; });
};
