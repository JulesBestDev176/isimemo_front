...
export const mockEncadrant = mockProfesseurs[0];
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
export const getProfesseurById = (id) => {
    return mockProfesseurs.find(p => p.idProfesseur === id);
};
export const getProfesseursDisponibles = () => {
 ...
 */
export const getProfesseurIdByEmail = (email) => {
