 ...
 */
export const detectSimilarDocuments = (idDossier) => {
 ...
 */
export const getSimilarityRiskLevel = (score) => {
    if (score >= 70)
        return 'high';
    if (score >= 40)
        return 'medium';
 ...
 */
export const getSimilarityRiskLabel = (score) => {
 ...
 */
export const getSimilarityRiskColor = (score) => {
