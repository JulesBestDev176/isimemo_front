...
(function (EtapeDossier) {
    ...
    EtapeDossier["CHOIX_BINOME"] = "CHOIX_BINOME";
    EtapeDossier["CHOIX_ENCADRANT"] = "CHOIX_ENCADRANT";
    EtapeDossier["VALIDATION_SUJET"] = "VALIDATION_SUJET";
    EtapeDossier["VALIDATION_COMMISSION"] = "VALIDATION_COMMISSION";
    // Onglet 2 : Dépôt dossier
    EtapeDossier["REDACTION"] = "REDACTION";
    EtapeDossier["DEPOT_INTERMEDIAIRE"] = "DEPOT_INTERMEDIAIRE";
    EtapeDossier["PRELECTURE"] = "PRELECTURE";
 ...
 */
export const getDossiersByCandidat = (idCandidat) => {
    return mockDossiers.filter(d => { var _a; return (_a = d.candidats) === null || _a === void 0 ? void 0 : _a.some(c => c.idCandidat === idCandidat); });
};
/**
 * Récupère le dossier en cours d'un candidat (un seul dossier EN_CREATION ou EN_COURS)
 * Règle métier : Un candidat ne peut avoir qu'un seul dossier en cours
 */
export const getDossierEnCoursByCandidat = (idCandidat) => {
    return mockDossiers.find(d => {
        var _a;
        const hasCandidat = (_a = d.candidats) === null || _a === void 0 ? void 0 : _a.some(c => c.idCandidat === idCandidat);
 ...
 */
export const getDossiersTerminesByCandidat = (idCandidat) => {
    return mockDossiers.filter(d => {
        var _a;
        return ((_a = d.candidats) === null || _a === void 0 ? void 0 : _a.some(c => c.idCandidat === idCandidat)) &&
 ...
 */
export const canCandidatCreerDossier = (idCandidat) => {
 ...
 */
export const mettreDepotEnPhasePublique = (idDossierMemoire) => {
 ...
 */
export const retirerDepotDePhasePublique = (idDossierMemoire) => {
    const dossier = mockDossiers.find(d => d.idDossierMemoire === idDossierMemoire);
    if (dossier) {
 ...
 */
export const getDepotsEnPhasePublique = () => {
