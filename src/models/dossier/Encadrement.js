...
// HELPER FUNCTIONS
// ============================================================================
export const getEncadrementById = (id) => {
    return mockEncadrements.find(e => e.idEncadrement === id);
};
export const getEncadrementsByProfesseur = (idProfesseur) => {
...
export const getEncadrementsActifs = (idProfesseur) => {
    // Un encadrant ne peut avoir qu'un seul encadrement actif
    const encadrementsActifs = getEncadrementsByProfesseur(idProfesseur).filter(e => e.statut === StatutEncadrement.ACTIF);
...
export const getEncadrementActif = (idProfesseur) => {
 ...
 */
export const getEncadrementActifByCandidat = (idCandidat) => {
    return mockEncadrements.find(e => {
        var _a, _b;
        return e.statut === StatutEncadrement.ACTIF &&
            ((_b = (_a = e.dossierMemoire) === null || _a === void 0 ? void 0 : _a.candidats) === null || _b === void 0 ? void 0 : _b.some(c => c.idCandidat === idCandidat));
    });
};
export const getEncadrementsByAnnee = (idProfesseur, anneeAcademique) => {
    return getEncadrementsByProfesseur(idProfesseur).filter(e => e.anneeAcademique === anneeAcademique);
};
/**
 * Récupère les encadrements associés à un dossier
 */
export const getEncadrementsByDossier = (idDossierMemoire) => {
    return mockEncadrements.filter(e => { var _a; return ((_a = e.dossierMemoire) === null || _a === void 0 ? void 0 : _a.idDossierMemoire) === idDossierMemoire; });
};
