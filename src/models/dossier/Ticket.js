...
(function (StatutTicket) {
    ...
    StatutTicket["TERMINE"] = "TERMINE"; // Ticket terminé et validé
...
(function (PhaseTicket) {
    ...
    PhaseTicket["TERMINE"] = "TERMINE"; // Ticket terminé et validé
 ...
 */
export const hasTicketEnCours = (idEncadrement) => {
    return mockTickets.some(t => {
        var _a;
        return ((_a = t.encadrement) === null || _a === void 0 ? void 0 : _a.idEncadrement) === idEncadrement &&
 ...
 */
export const getTicketEnCours = (idEncadrement) => {
 ...
 */
export const hasTicketEnRevision = (idEncadrement) => {
    return mockTickets.some(t => {
        var _a;
        return ((_a = t.encadrement) === null || _a === void 0 ? void 0 : _a.idEncadrement) === idEncadrement &&
 ...
 */
export const getTicketEnRevision = (idEncadrement) => {
    return mockTickets.find(t => {
        var _a;
        return ((_a = t.encadrement) === null || _a === void 0 ? void 0 : _a.idEncadrement) === idEncadrement &&
            t.phase === PhaseTicket.EN_REVISION;
 ...
 * - Si un ticket est EN_REVISION, aucun ticket ne peut être EN_COURS
 */
export const canDemarrerTicketEnCours = (idEncadrement) => {
 ...
 * Règle métier : On ne peut avoir qu'un seul ticket EN_REVISION à la fois
 */
export const canDemarrerTicketEnRevision = (idEncadrement) => {
    return !hasTicketEnRevision(idEncadrement);
};
/**
 * Récupère tous les tickets pour un encadrement, triés par phase
 */
export const getTicketsByEncadrement = (idEncadrement) => {
    return mockTickets
        .filter(t => { var _a; return ((_a = t.encadrement) === null || _a === void 0 ? void 0 : _a.idEncadrement) === idEncadrement; })
        .sort((a, b) => {
 ...
 */
export const getTicketsByDossier = (idDossierMemoire) => {
    return mockTickets
        .filter(t => { var _a; return ((_a = t.dossierMemoire) === null || _a === void 0 ? void 0 : _a.idDossierMemoire) === idDossierMemoire; })
        .sort((a, b) => {
        // Ordre de priorité des phases
        const phaseOrder = {
            [PhaseTicket.EN_COURS]: 1,
 ...
 */
export const createTicketForDossier = (encadrement, dossierMemoire, titre, description, priorite = Priorite.MOYENNE, consigne, sousTaches) => {
