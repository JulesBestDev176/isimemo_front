...
export const mockDocumentsAdministratifs = [
    {
        idDocument: 201,
        titre: 'Copie CNI',
...
export const getDocumentsByDossier = (dossierId) => {
    ...
    return mockDocuments.filter(d => { var _a; return ((_a = d.dossierMemoire) === null || _a === void 0 ? void 0 : _a.idDossierMemoire) === dossierId; });
};
export const getDocumentsValides = () => {
 ...
 */
export const retirerDocumentDePhasePublique = (idDocument) => {
    const document = mockDocuments.find(d => d.idDocument === idDocument);
    if (document) {
 ...
 */
export const getDocumentsEnPhasePublique = () => {
