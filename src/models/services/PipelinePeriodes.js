...
export var TypeEtapePipeline;
(function (TypeEtapePipeline) {
    TypeEtapePipeline["DEBUT_ANNEE"] = "DEBUT_ANNEE";
    TypeEtapePipeline["DEPOT_SUJET_ET_ENCADREMENT"] = "DEPOT_SUJET_ET_ENCADREMENT";
    TypeEtapePipeline["VALIDATION_SUJETS"] = "VALIDATION_SUJETS";
    TypeEtapePipeline["PRELECTURE"] = "PRELECTURE";
    TypeEtapePipeline["RENSEIGNEMENT_DISPONIBILITE"] = "RENSEIGNEMENT_DISPONIBILITE";
    TypeEtapePipeline["DEPOT_FINAL"] = "DEPOT_FINAL";
    TypeEtapePipeline["SESSION_SOUTENANCE"] = "SESSION_SOUTENANCE";
    TypeEtapePipeline["VALIDATION_CORRECTIONS"] = "VALIDATION_CORRECTIONS";
    TypeEtapePipeline["FIN_ANNEE"] = "FIN_ANNEE"; // Fin de l'année académique
})(TypeEtapePipeline || (TypeEtapePipeline = {}));
export var StatutEtape;
(function (StatutEtape) {
    StatutEtape["PAS_COMMENCEE"] = "PAS_COMMENCEE";
    StatutEtape["PLANIFIEE"] = "PLANIFIEE";
    StatutEtape["ACTIVE"] = "ACTIVE";
    StatutEtape["TERMINEE"] = "TERMINEE";
    StatutEtape["BLOQUEE"] = "BLOQUEE";
 ...
 */
export const estDateArrivee = (date) => {
    if (!date)
        return false;
 ...
 */
export const estDansPeriode = (dateDebut, dateFin) => {
    if (!dateDebut)
        return false;
    const maintenant = new Date();
 ...
 */
export const calculerStatutEtape = (dateDebut, dateFin, estActive) => {
    if (!dateDebut) {
 ...
 */
export const peutActiverEtape = (etape, etapesPrecedentes) => {
 ...
 */
export const peutDesactiverEtape = (etape) => {
 ...
 */
export const construirePipeline = (anneeAcademique, periodeDepotSujet, // Inclut aussi la demande d'encadrement (même période)
periodeValidationSujets, periodesPrelecture, // Répétitif, lié à chaque session
periodesDisponibilite, // Répétitif, lié à chaque session (peut continuer après dépôt final)
periodesDepotFinal, // Répétitif, lié à chaque session
sessionsSoutenance, // Seulement sessions principales (Septembre, Décembre)
periodesValidationCorrections // Répétitif, une par session
) => {
    const pipeline = [];
    ...
    pipeline.push({
        ...
        peutActiver: peutActiverEtape({ id: TypeEtapePipeline.DEBUT_ANNEE, nom: '', description: '', ordre: 1, statut: StatutEtape.PAS_COMMENCEE, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: false }, []),
    ...
    if (periodeDepotSujet) {
        ...
        pipeline.push({
            ...
            peutActiver: peutActiverEtape({ id: TypeEtapePipeline.DEPOT_SUJET_ET_ENCADREMENT, nom: '', description: '', ordre: 2, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: false, dateDebut: periodeDepotSujet.dateDebut, dateFin: periodeDepotSujet.dateFin }, pipeline),
    ...
    if (periodeValidationSujets) {
        ...
        pipeline.push({
            ...
            peutActiver: peutActiverEtape({ id: TypeEtapePipeline.VALIDATION_SUJETS, nom: '', description: '', ordre: 3, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: false, dateDebut: periodeValidationSujets.dateDebut, dateFin: periodeValidationSujets.dateFin }, pipeline),
    ...
    const sessionsPrincipales = sessionsSoutenance ? [...sessionsSoutenance]
        ...
        if (a.typeSession === TypeSessionSoutenance.SEPTEMBRE && b.typeSession === TypeSessionSoutenance.DECEMBRE)
            return -1;
        if (a.typeSession === TypeSessionSoutenance.DECEMBRE && b.typeSession === TypeSessionSoutenance.SEPTEMBRE)
            return 1;
        // Puis par date
    ...
    if (sessionsPrincipales.length > 0) {
        sessionsPrincipales.forEach((session) => {
            ...
            const prelectureAssociee = periodesPrelecture === null || periodesPrelecture === void 0 ? void 0 : periodesPrelecture.find(p => p.sessionSoutenanceId === session.idSession);
            const depotFinalAssocie = periodesDepotFinal === null || periodesDepotFinal === void 0 ? void 0 : periodesDepotFinal.find(p => p.sessionSoutenanceId === session.idSession);
            const validationCorrectionsAssociee = periodesValidationCorrections === null || periodesValidationCorrections === void 0 ? void 0 : periodesValidationCorrections.find(p => p.sessionSoutenanceId === session.idSession);
            ...
            if (prelectureAssociee) {
                ...
                pipeline.push({
                    ...
                    peutActiver: peutActiverEtape({ id: TypeEtapePipeline.PRELECTURE, nom: '', description: '', ordre: ordreActuel, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: true, dateDebut: prelectureAssociee.dateDebut, dateFin: prelectureAssociee.dateFin }, pipeline),
            ...
            const disponibiliteAssociee = periodesDisponibilite === null || periodesDisponibilite === void 0 ? void 0 : periodesDisponibilite.find(p => p.sessionSoutenanceId === session.idSession);
            if (disponibiliteAssociee) {
                ...
                pipeline.push({
                    ...
                    peutActiver: peutActiverEtape({ id: TypeEtapePipeline.RENSEIGNEMENT_DISPONIBILITE, nom: '', description: '', ordre: ordreActuel, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: true, dateDebut: disponibiliteAssociee.dateDebut, dateFin: disponibiliteAssociee.dateFin }, pipeline),
            ...
            if (depotFinalAssocie) {
                ...
                pipeline.push({
                    ...
                    peutActiver: peutActiverEtape({ id: TypeEtapePipeline.DEPOT_FINAL, nom: '', description: '', ordre: ordreActuel - 1, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: true, dateDebut: depotFinalAssocie.dateDebut, dateFin: depotFinalAssocie.dateFin }, pipeline),
            ...
            pipeline.push({
                ...
                peutActiver: peutActiverEtape({ id: TypeEtapePipeline.SESSION_SOUTENANCE, nom: '', description: '', ordre: ordreActuel - 1, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: true, dateDebut: session.dateDebut, dateFin: session.dateFin }, pipeline),
            ...
            if (validationCorrectionsAssociee) {
                ...
                pipeline.push({
                    ...
                    peutActiver: peutActiverEtape({ id: TypeEtapePipeline.VALIDATION_CORRECTIONS, nom: '', description: '', ordre: ordreActuel - 1, statut, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: true, dateDebut: validationCorrectionsAssociee.dateDebut, dateFin: validationCorrectionsAssociee.dateFin }, pipeline),
    ...
    pipeline.push({
        ...
        peutActiver: false,
        peutDesactiver: peutDesactiverEtape({ id: TypeEtapePipeline.FIN_ANNEE, nom: '', description: '', ordre: 999, statut: anneeAcademique.estActive ? StatutEtape.ACTIVE : StatutEtape.PAS_COMMENCEE, peutActiver: false, peutDesactiver: false, estRequis: true, estRepetitive: false, dateDebut: anneeAcademique.dateFin, dateFin: anneeAcademique.dateFin }, pipeline),
        estRequis: true,
        estRepetitive: false,
        donnees: { anneeAcademique }
    });
