 ...
 */
export const simulateEmbedding = (text) => {
    if (!text)
 ...
 */
export const calculateContentSimilarity = (resource1, resource2) => {
...
export class RecommendationEngine {
     ...
     */
    static getContentBasedRecommendations(userId, userTopResources, allResources, limit = 6) {
        ...
        userTopResources.forEach(likedResourceId => {
            ...
            allResources.forEach(resource => {
                ...
                if (userTopResources.includes(resource.idRessource))
                    return;
     ...
     */
    static getPopularRecommendations(allResources, limit = 6) {
     ...
     */
    static getRecentRecommendations(allResources, limit = 6) {
     ...
     */
    static getHybridRecommendations(userId, allResources, limit = 6) {
        ...
        const uniqueRecommendations = Array.from(new Map(recommendations.map(r => [r.ressource.idRessource, r])).values());
